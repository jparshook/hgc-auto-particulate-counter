...
#  noise_vpp = max_value - min_value
  ...
  print("temperature:"+ str(round(bme280_data[0], 2)))
  print("humidity:"+ str(round(bme280_data[2], 2)))
  print("pm0_5:"+ str(particulates(particulate_data, PM0_5_PER_LITRE)))
  print("pm1:"+ str(particulates(particulate_data, PM1_PER_LITRE)))
  print("pm5:"+ str(particulates(particulate_data, PM5_PER_LITRE)))
